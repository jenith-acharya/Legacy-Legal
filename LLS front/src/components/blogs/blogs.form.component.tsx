        ...
        return(
            ...
            <div className="grid gap-4 sm:grid-cols-2 sm:gap-6">
              ...
              <div className="sm:col-span-2">
                ...
                <div className="w-1/4">
                <img 
                  src={thumbnail ? (typeof thumbnail === 'string'? thumbnail : URL.createObjectURL(thumbnail)) : "https://placehold.co/600x400?text=No+Image+Found" } alt="Image" className="max-w-full" />
